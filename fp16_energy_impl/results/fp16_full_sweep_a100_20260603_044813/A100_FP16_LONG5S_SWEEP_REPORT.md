...
![A100 full 5s sweep](./figures/a100_long5s_sweep_pjbit_elapsed.png)
...
| Artifact | Path |
|---|---|
| full-sweep report source | `./` |
| full-sweep summary | `./thread_sweep_summary.csv` |
| full-sweep quality gate summary | `./quality_gate_summary.json` |
| selected target work-slope | `./work_slope_selected/work_slope_summary.csv` |
| lowest mean work-slope | `./work_slope_lowest_t192_b8/work_slope_summary.csv` |
